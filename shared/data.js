...
(function(){
  const sections = [
    ['Q1. 지각된 인간 노력 Perceived Human Effort', [
      '나는 이 영상을 만드는 과정에서 상당한 노력을 들였다고 느꼈다.',
      '이 영상을 만드는 데 나의 적극적인 작업이 필요했다고 느꼈다.',
      '영상 제작 과정에서 어떤 선택을 할지 신중하게 생각해야 했다고 느꼈다.',
      '최종 영상에는 나의 입력과 노력이 반영되어 있다고 느꼈다.',
      '최종 영상이 어떻게 만들어졌는지에 내가 상당히 기여했다고 느꼈다.',
      '이 영상은 나의 노력이 거의 없이 만들어졌다고 느꼈다. [역문항]'
    ]],
    ['Q2. 지각된 AI 자율성 Perceived AI Autonomy', [
      ...
      'AI는 스스로 결정하기보다는 주로 내가 선택한 내용을 따랐다고 느꼈다. [역문항]'
    ]],
