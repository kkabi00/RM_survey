...
(function(){
  const sections = [
    ...
    ['Q4. 지각된 위반 심각성 Perceived Transgression Severity', [
      '이 영상을 만든 행위는 잘못이라고 느낀다.',
      '이 영상 제작 행위는 도덕적으로 문제라고 느낀다.',
      '이 영상을 만들거나 공유하는 것은 영상 속 인물 Hans를 창피하게 만들 수 있다.',
      '이 영상은 Hans의 존엄성이나 평판에 부정적인 영향을 줄 수 있다.',
      '이 상황에서 Hans의 동의가 없었다는 점은 문제라고 느낀다.',
      '대부분의 사람들은 이 행동을 도덕적으로 받아들이기 어려우리라 생각한다.',
      '이 상황은 해롭지 않은 장난일 뿐이다. [역문항]',
      '이런 영상을 만든다는 점에 문제가 될 부분은 없다. [역문항]'
    ]],
    ['Q5. 죄책감 Guilt', [
